...
function makeFinalJson()
{
    ...
    $response = [
        'clave' => $clave,
        'fecha' => $fecha,
        'emisor' => ['tipoIdentificacion' => $emi_tipoIdentificacion, 'numeroIdentificacion' => $emi_numeroIdentificacion],
        'receptor' => ['tipoIdentificacion' => $recp_tipoIdentificacion, 'numeroIdentificacion' => $recp_numeroIdentificacion],
