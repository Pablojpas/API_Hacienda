...
function wirez_init()
{
    $paths = [
        ...
        [
            ...
            'params' => [
                ['key' => 'from',              'def' => '', 'req' => true],
                ['key' => 'to',                'def' => '', 'req' => true],
                ['key' => 'idConversation',    'def' => '', 'req' => true],
                ['key' => 'subject',           'def' => '', 'req' => false],
                ['key' => 'text',              'def' => '', 'req' => true],
            ],
        ...
        [
            ...
            'access' => 'users_loggedIn',
            'params' => [
                ['key' => 'lastMsgId',         'def' => '0', 'req' => false],
                ['key' => 'idConversation',    'def' => '0', 'req' => false],
                ['key' => 'withWire',          'def' => '', 'req' => true],
                ['key' => 'textLike',          'def' => '', 'req' => false],
            ],
        ...
        [
            ...
            'access' => 'users_loggedIn',
            'params' => [
                ['key' => 'lastMessageId', 'def' => '0', 'req' => false],
            ],
        ...
        [
            ...
            'access' => 'users_loggedIn',
            'params' => [['key' => 'idConversation', 'def' => '0', 'req' => false]],
