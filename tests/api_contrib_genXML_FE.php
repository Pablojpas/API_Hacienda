...
class api_contrib_genXML_FE extends TestCase
{
    ...
    public function test_test_function()
    {
        $this->assertEquals('Esto es un test', test());
    }

    public function test_gen_xml_fe_basic()
    {
        $result = genXMLFe();
    ...
    public function test_gen_xml_fe_informacion_referencia()
    {
        $result = genXMLFe();
        $xmlString = base64_decode($result['xml']);
        // Print the XML output to the console
    ...
    public function test_gen_xml_fe_otros()
    {
        $result = genXMLFe();
        $xmlString = base64_decode($result['xml']);
        // Print the XML output to the console
    ...
    public function test_gen_xml_fe_medio_pago()
    {
        $result = genXMLFe();
        $xmlString = base64_decode($result['xml']);
        $xml = new SimpleXMLElement($xmlString);
    ...
    public function test_gen_xml_fe_full_structure()
    {
    ...
    public function test_gen_xml_fe_receptor()
    {
        $result = genXMLFe();
        $xmlString = base64_decode($result['xml']);
        $xml = new SimpleXMLElement($xmlString);
    ...
    public function test_gen_xml_fe_resumen_factura()
    {
        $result = genXMLFe();
        $xmlString = base64_decode($result['xml']);
        $xml = new SimpleXMLElement($xmlString);
    ...
    public function test_gen_xml_fe_emisor()
    {
        $result = genXMLFe();
        $xmlString = base64_decode($result['xml']);
        $xml = new SimpleXMLElement($xmlString);
    ...
    public function test_gen_xml_fe_detalle_servicio()
    {
        $result = genXMLFe();
        $xmlString = base64_decode($result['xml']);
        $xml = new SimpleXMLElement($xmlString);
